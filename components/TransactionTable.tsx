...
import { formatAmount, getTransactionStatus, formatDateTime } from '@/lib/utils'
    ...
    <Table>
      ...
      <TableBody>
        {transactions.map((transaction: Transaction) => {
          ...
          return (
            <TableRow key={transaction.id} className={`${isDebit || amount[0] === '-' ? 'bg-[#ffede8]' : 'bg-[#e3feed]'} !over:bg-none !border-b-DEFAULT`}>
